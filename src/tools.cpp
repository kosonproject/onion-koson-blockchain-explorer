...
/**
* Parse Koson address in a string form into
...
/**
* Return string representation of koson address
*/
string
...
{
    // default path to koson folder
    // on linux this is /home/<username>/.koson
    string default_koson_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_koson_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_koson_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_koson_dir + string("/lmdb");
}
