var config = {
    ...
    coinUnitPlaces: 9,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Koson
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Koson
    coinSymbol: 'KSN',
    openAliasPrefix: "ksn",
    coinName: 'Koson',
    coinUriPrefix: 'koson:',
